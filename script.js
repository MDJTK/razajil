...
window.Webflow ||= [];
window.Webflow.push(() => {
    console.log("Webflow has loaded. Executing my script...");

    // Example: Force hiding Webflow badge
    var badge = document.querySelector(".w-webflow-badge");
    if (badge) badge.style.display = "none";

    // Example: Override any Webflow function (if needed)
    window.SomeWebflowFunction = function() {
        console.log("My script has overridden a Webflow function!");
    };
});
...
( () => {
    ...
    ;
    var de = (e, t, n) => (n = e != null ? zv(Yv(e)) : {},
    da(t || !e || !e.__esModule ? Pn(n, "default", {
        value: e,
        enumerable: !0
    }) : n, e))
      , Qe = e => da(Pn({}, "__esModule", {
        value: !0
    }), e);
    var pa = f( () => {
        "use strict";
    ...
    var Kr = f( () => {
        ...
        window.tram = function(e) {
            ...
            function i(c, _, w) {
                return "#" + (1 << 24 | c << 16 | _ << 8 | w).toString(16).slice(1)
            }
            function o() {}
            function s(c, _) {
            ...
            function u(c, _, w) {
                ...
                c === void 0)
                    return w;
                var x = w;
                return Oe.test(c) || !ke.test(c) ? x = parseInt(c, 10) : ke.test(c) && (x = 1e3 * parseFloat(c)),
                0 > x && (x = 0),
                x === x ? x : w
            }
            function l(c) {
            ...
            var v = function(c, _, w) {
                ...
                function J(ae, ee) {
                    function V() {
                        var xe = new ue;
                        return P(xe.init) && xe.init.apply(xe, arguments),
                        xe
                    }
                    function ue() {}
                    ee === w && (ee = ae,
                    ae = Object),
                    V.Bare = ue;
                    var ce, _e = N[c] = ae[c], Ge = ue[c] = V[c] = new N;
                    return Ge.constructor = V,
                    V.mixin = function(xe) {
                        return ue[c] = V[c] = J(V, xe)[c],
                        V
                    }
                    ,
                    V.open = function(xe) {
                        ...
                        x(ce))
                            for (var tn in ce)
                                _.call(ce, tn) && (Ge[tn] = ce[tn]);
                        return P(Ge.init) || (Ge.init = ae),
                        V
                    }
                    ,
                    V.open(ee)
              ...
              , p = {
                ease: ["ease", function(c, _, w, x) {
                    var P = (c /= x) * c
                      , N = P * c;
                    return _ + w * (-2.75 * N * P + 11 * P * P + -15.5 * N + 8 * P + .25 * c)
                }
                ],
                "ease-in": ["ease-in", function(c, _, w, x) {
                    var P = (c /= x) * c
                      , N = P * c;
                    return _ + w * (-1 * N * P + 3 * P * P + -3 * N + 2 * P)
                }
                ],
                "ease-out": ["ease-out", function(c, _, w, x) {
                    var P = (c /= x) * c
                      , N = P * c;
                    return _ + w * (.3 * N * P + -1.6 * P * P + 2.2 * N + -1.8 * P + 1.9 * c)
                }
                ],
                "ease-in-out": ["ease-in-out", function(c, _, w, x) {
                    var P = (c /= x) * c
                      , N = P * c;
                    return _ + w * (2 * N * P + -5 * P * P + 2 * N + 2 * P)
                }
                ],
                linear: ["linear", function(c, _, w, x) {
                    return w * c / x + _
                }
                ],
                "ease-in-quad": ["cubic-bezier(0.550, 0.085, 0.680, 0.530)", function(c, _, w, x) {
                    return w * (c /= x) * c + _
                }
                ],
                "ease-out-quad": ["cubic-bezier(0.250, 0.460, 0.450, 0.940)", function(c, _, w, x) {
                    return -w * (c /= x) * (c - 2) + _
                }
                ],
                "ease-in-out-quad": ["cubic-bezier(0.455, 0.030, 0.515, 0.955)", function(c, _, w, x) {
                    return (c /= x / 2) < 1 ? w / 2 * c * c + _ : -w / 2 * (--c * (c - 2) - 1) + _
                }
                ],
                "ease-in-cubic": ["cubic-bezier(0.550, 0.055, 0.675, 0.190)", function(c, _, w, x) {
                    return w * (c /= x) * c * c + _
                }
                ],
                "ease-out-cubic": ["cubic-bezier(0.215, 0.610, 0.355, 1)", function(c, _, w, x) {
                    return w * ((c = c / x - 1) * c * c + 1) + _
                }
                ],
                "ease-in-out-cubic": ["cubic-bezier(0.645, 0.045, 0.355, 1)", function(c, _, w, x) {
                    return (c /= x / 2) < 1 ? w / 2 * c * c * c + _ : w / 2 * ((c -= 2) * c * c + 2) + _
                }
                ],
                "ease-in-quart": ["cubic-bezier(0.895, 0.030, 0.685, 0.220)", function(c, _, w, x) {
                    return w * (c /= x) * c * c * c + _
                }
                ],
                "ease-out-quart": ["cubic-bezier(0.165, 0.840, 0.440, 1)", function(c, _, w, x) {
                    return -w * ((c = c / x - 1) * c * c * c - 1) + _
                }
                ],
                "ease-in-out-quart": ["cubic-bezier(0.770, 0, 0.175, 1)", function(c, _, w, x) {
                    return (c /= x / 2) < 1 ? w / 2 * c * c * c * c + _ : -w / 2 * ((c -= 2) * c * c * c - 2) + _
                }
                ],
                "ease-in-quint": ["cubic-bezier(0.755, 0.050, 0.855, 0.060)", function(c, _, w, x) {
                    return w * (c /= x) * c * c * c * c + _
                }
                ],
                "ease-out-quint": ["cubic-bezier(0.230, 1, 0.320, 1)", function(c, _, w, x) {
                    return w * ((c = c / x - 1) * c * c * c * c + 1) + _
                }
                ],
                "ease-in-out-quint": ["cubic-bezier(0.860, 0, 0.070, 1)", function(c, _, w, x) {
                    return (c /= x / 2) < 1 ? w / 2 * c * c * c * c * c + _ : w / 2 * ((c -= 2) * c * c * c * c + 2) + _
                }
                ],
                "ease-in-sine": ["cubic-bezier(0.470, 0, 0.745, 0.715)", function(c, _, w, x) {
                    return -w * Math.cos(c / x * (Math.PI / 2)) + w + _
                }
                ],
                "ease-out-sine": ["cubic-bezier(0.390, 0.575, 0.565, 1)", function(c, _, w, x) {
                    return w * Math.sin(c / x * (Math.PI / 2)) + _
                }
                ],
                "ease-in-out-sine": ["cubic-bezier(0.445, 0.050, 0.550, 0.950)", function(c, _, w, x) {
                    return -w / 2 * (Math.cos(Math.PI * c / x) - 1) + _
                }
                ],
                "ease-in-expo": ["cubic-bezier(0.950, 0.050, 0.795, 0.035)", function(c, _, w, x) {
                    return c === 0 ? _ : w * Math.pow(2, 10 * (c / x - 1)) + _
                }
                ],
                "ease-out-expo": ["cubic-bezier(0.190, 1, 0.220, 1)", function(c, _, w, x) {
                    return c === x ? _ + w : w * (-Math.pow(2, -10 * c / x) + 1) + _
                }
                ],
                "ease-in-out-expo": ["cubic-bezier(1, 0, 0, 1)", function(c, _, w, x) {
                    return c === 0 ? _ : c === x ? _ + w : (c /= x / 2) < 1 ? w / 2 * Math.pow(2, 10 * (c - 1)) + _ : w / 2 * (-Math.pow(2, -10 * --c) + 2) + _
                }
                ],
                "ease-in-circ": ["cubic-bezier(0.600, 0.040, 0.980, 0.335)", function(c, _, w, x) {
                    return -w * (Math.sqrt(1 - (c /= x) * c) - 1) + _
                }
                ],
                "ease-out-circ": ["cubic-bezier(0.075, 0.820, 0.165, 1)", function(c, _, w, x) {
                    return w * Math.sqrt(1 - (c = c / x - 1) * c) + _
                }
                ],
                "ease-in-out-circ": ["cubic-bezier(0.785, 0.135, 0.150, 0.860)", function(c, _, w, x) {
                    return (c /= x / 2) < 1 ? -w / 2 * (Math.sqrt(1 - c * c) - 1) + _ : w / 2 * (Math.sqrt(1 - (c -= 2) * c) + 1) + _
                }
                ],
                "ease-in-back": ["cubic-bezier(0.600, -0.280, 0.735, 0.045)", function(c, _, w, x, P) {
                    return P === void 0 && (P = 1.70158),
                    w * (c /= x) * c * ((P + 1) * c - P) + _
                }
                ],
                "ease-out-back": ["cubic-bezier(0.175, 0.885, 0.320, 1.275)", function(c, _, w, x, P) {
                    return P === void 0 && (P = 1.70158),
                    w * ((c = c / x - 1) * c * ((P + 1) * c + P) + 1) + _
                }
                ],
                "ease-in-out-back": ["cubic-bezier(0.680, -0.550, 0.265, 1.550)", function(c, _, w, x, P) {
                    return P === void 0 && (P = 1.70158),
                    (c /= x / 2) < 1 ? w / 2 * c * c * (((P *= 1.525) + 1) * c - P) + _ : w / 2 * ((c -= 2) * c * (((P *= 1.525) + 1) * c + P) + 2) + _
                }
                ]
            }
              , y = {
            ...
            if (B.transition) {
                var ne = B.timing.dom;
                if (q.style[ne] = p["ease-in-back"][0],
                !q.style[ne])
                    for (var re in y)
                        p[re][0] = y[re]
            }
            var le = t.frame = function() {
              ...
              , E = v(function(c) {
                function _(ie, fe) {
                    ...
                    var Re = U[he];
                    if (!Re)
                        return l("Unsupported property: " + he);
                    if (!fe.weak || !this.props[he]) {
                        var We = Re[0]
                          , Ne = this.props[he];
                        return Ne || (Ne = this.props[he] = new We.Bare),
                ...
                function w(ie, fe, Ee) {
                    if (ie) {
                        ...
                        if (he == "object") {
                            var Re = 0;
                            Ge.call(this, ie, function(Te, Hv) {
                                Te.span > Re && (Re = Te.span),
                                Te.stop(),
                                Te.animate(Hv)
                            }, function(Te) {
                ...
                function J(ie) {
                    ...
                    var fe;
                    typeof ie == "string" ? (fe = {},
                    fe[ie] = 1) : fe = typeof ie == "object" && ie != null ? ie : this.props,
                    Ge.call(this, fe, xe),
                    _e.call(this)
                }
                function ae(ie) {
                    J.call(this, ie),
                    Ge.call(this, ie, tn, Wv)
                }
                function ee(ie) {
                ...
                function _e() {
                    ...
                    this.el.style[B.transition.dom] = Ee)
                }
                function Ge(ie, fe, Ee) {
                    var he, Re, We, Ne, Ln = fe !== xe, Te = {};
                    for (he in ie)
                        We = ie[he],
                        he in pe ? (Te.transform || (Te.transform = {}),
                        Te.transform[he] = We) : (R.test(he) && (he = n(he)),
                        he in U ? Te[he] = We : (Ne || (Ne = {}),
                        Ne[he] = We));
                    for (he in Te) {
                        if (We = Te[he],
                        Re = this.props[he],
                ...
                function Ue(ie, fe) {
                    c[ie] = function() {
                        return this.children ? Bv.call(this, fe, arguments) : (this.el && fe.apply(this, arguments),
                        this)
                    }
                }
                function Bv(ie, fe) {
                ...
                c.init = function(ie) {
                    ...
                    B.backface && K.hideBackface && d(this.el, B.backface.css, "hidden")
                }
                ,
                Ue("add", _),
                Ue("start", w),
              ...
              , h = v(function(c) {
                ...
                function w(N, J, ae) {
                    return J !== void 0 && (ae = J),
                    N in p ? N : ae
                }
                function x(N) {
                    var J = /rgba?\((\d+),\s*(\d+),\s*(\d+)/.exec(N);
                    return (J ? i(J[1], J[2], J[3]) : N).replace(/#(\w)(\w)(\w)$/, "#$1$1$2$2$3$3")
                }
                var P = {
                    duration: 500,
                    ease: "ease",
                ...
                c.init = function(N, J, ae, ee) {
                    ...
                    K.fallback || ee.fallback ? this.animate = this.fallback : (this.animate = this.transition,
                    this.string = this.name + te + this.duration + "ms" + (this.ease != "ease" ? te + p[this.ease][0] : "") + (this.delay ? te + this.delay + "ms" : ""))
                }
                ,
                c.set = function(N) {
                ...
                c.convert = function(N, J) {
                    if (N == "auto" && this.auto)
                        return N;
                    var ae, ee = typeof N == "number", V = typeof N == "string";
                    switch (J) {
                    case O:
                        if (ee)
                            return N;
              ...
              , G = v(h, function(c, _) {
                ...
                c.init = function() {
                    ...
                    pe.perspective && K.perspective && (this.current.perspective = K.perspective,
                ...
                c.values = function(x) {
                    var P, N = {};
                    return w.call(this, x, function(J, ae, ee) {
                        N[J] = ae,
                        this.current[J] === void 0 && (P = 0,
                        ~J.indexOf("scale") && (P = 1),
              ...
              , Z = v(function(c) {
                ...
                function N(V, ue, ce) {
                    return i(V[0] + ce * (ue[0] - V[0]), V[1] + ce * (ue[1] - V[1]), V[2] + ce * (ue[2] - V[2]))
                }
                var J = {
                    ease: p.ease[1],
                    from: 0,
                ...
                ,
                c.play = function() {
                    this.active || (this.start || (this.start = Ie()),
                    this.active = !0,
                    _(this))
                }
                ,
                ...
                c.render = function(V) {
                    ...
                    if (ce < this.duration) {
                        ...
                        return ue = this.startRGB ? N(this.startRGB, this.endRGB, _e) : P(this.begin + _e * this.change),
              ...
              , se = v(Z, function(c, _) {
                c.init = function(w) {
                    ...
                    for (x in w.values)
                        P = w.values[x],
                        this.current[x] !== P && this.tweens.push(new Z({
                            name: x,
                            from: this.current[x],
                            to: P,
                            duration: w.duration,
                ...
                ,
                c.render = function(w) {
                    var x, P, N = this.tweens.length, J = !1;
                    for (x = N; x--; )
                        P = this.tweens[x],
                        P.context && (P.render(w),
            ...
            B.transform && B.backface && (pe.z = [C, "translateZ"],
            pe.rotateZ = [W],
            pe.scaleZ = [O],
            pe.perspective = [D]);
            var Oe = /ms/
    ...
    var va = f( (FF, ga) => {
        ...
        ga.exports = function() {
            ...
            var t = {}
              ...
              , L = Object.keys
              , D = i.bind
              , C = e.each = e.forEach = function(A, M, j) {
                if (A == null)
                    return A;
                if (m && A.forEach === m)
                    A.forEach(M, j);
                    ...
                    for (var B = 0, ne = A.length; B < ne; B++)
                        if (M.call(j, A[B], B, A) === t)
                            return
                } else
                    for (var re = e.keys(A), B = 0, ne = re.length; B < ne; B++)
                        if (M.call(j, A[re[B]], re[B], A) === t)
                            return;
                return A
            }
            ;
            e.map = e.collect = function(A, M, j) {
                var B = [];
                return A == null ? B : v && A.map === v ? A.map(M, j) : (C(A, function(ne, re, le) {
                    B.push(M.call(j, ne, re, le))
                }),
                B)
            }
            ,
            e.find = e.detect = function(A, M, j) {
                var B;
                return W(A, function(ne, re, le) {
                    if (M.call(j, ne, re, le))
                        return B = ne,
                        !0
                }),
                B
            ...
            ,
            e.filter = e.select = function(A, M, j) {
                var B = [];
                return A == null ? B : T && A.filter === T ? A.filter(M, j) : (C(A, function(ne, re, le) {
                    M.call(j, ne, re, le) && B.push(ne)
                }),
                B)
            }
            ;
            var W = e.some = e.any = function(A, M, j) {
                M || (M = e.identity);
                var B = !1;
                return A == null ? B : S && A.some === S ? A.some(M, j) : (C(A, function(ne, re, le) {
                    if (B || (B = M.call(j, ne, re, le)))
                        return t
                }),
                !!B)
            }
            ...
            e.contains = e.include = function(A, M) {
                return A == null ? !1 : b && A.indexOf === b ? A.indexOf(M) != -1 : W(A, function(j) {
                    return j === M
                })
            }
            ,
            ...
            e.debounce = function(A, M, j) {
                var B, ne, re, le, Ie, E = function() {
                    var k = e.now() - le;
                    k < M ? B = setTimeout(E, M - k) : (B = null,
                    j || (Ie = A.apply(re, ne),
                    re = ne = null))
                };
                return function() {
            ...
            var H = /(.)^/
              ...
              , q = /^\s*(\w|\$)+\s*$/;
            return e.template = function(A, M, j) {
                !M && j && (M = j),
                ...
                A.replace(B, function(k, h, g, X, G) {
                    return re += A.slice(ne, G).replace(Q, te),
                    ne = G + k.length,
                    h ? re += `'+
...
` + re + "}",
    ...
    var Xe = f( (qF, wa) => {
        ...
        var Nn = navigator.userAgent.toLowerCase()
          , Ia = ge.env.touch = "ontouchstart"in window || window.DocumentTouch && document instanceof window.DocumentTouch
          , ny = ge.env.chrome = /chrome/.test(Nn) && /Google/.test(navigator.vendor) && parseInt(Nn.match(/chrome\/(\d+)\./)[1], 10)
        ...
        function Zr(e, t) {
            var n = []
              , r = {};
            return r.up = Be.throttle(function(i) {
    ...
    var Oa = f( (kF, Sa) => {
        ...
        Aa.define("brand", Sa.exports = function(e) {
            var t = {}, n = document, r = e("html"), i = e("body"), o = ".w-webflow-badge", s = window.location, a = /PhantomJS/i.test(navigator.userAgent), u = "fullscreenchange webkitfullscreenchange mozfullscreenchange msfullscreenchange", l;
            t.ready = function() {
            ...
            function v() {
                var y = e('<a class=""></a>').attr("href", "")
                  , T = e("<img>").attr("src", "").attr("alt", "").css({
                    marginRight: "4px",
                    width: "26px"
                })
    ...
    var Ra = f( (GF, xa) => {
        "use strict";
        var Jr = Xe();
        Jr.define("edit", xa.exports = function(e, t, n) {
            if (n = n || {},
            (Jr.env("test") || Jr.env("frame")) && !n.fixture && !ay())
                return {
                    exit: 1
                };
            var r = {}, i = e(window), o = e(document.documentElement), s = document.location, a = "hashchange", u, l = n.load || p, m = !1;
            try {
                m = localStorage && localStorage.getItem && localStorage.getItem("WebflowEditor")
            } catch {}
            m ? l() : s.search ? (/[?&](edit)(?:[=&?]|$)/.test(s.search) || /\?edit$/.test(s.href)) && l() : i.on(a, v).triggerHandler(a);
            function v() {
            ...
            function R(L) {
                ...
                var C = function(W) {
                    W.data === "WF_third_party_cookies_unsupported" ? (O(D, C),
                    L(!1)) : W.data === "WF_third_party_cookies_supported" && (O(D, C),
                    L(!0))
                };
                D.onerror = function() {
                    O(D, C),
    ...
    var La = f( (XF, Ca) => {
        "use strict";
        var sy = Xe();
        sy.define("focus-visible", Ca.exports = function() {
            function e(n) {
                var r = !0
                  , i = !1
                  , o = null
                ...
                function u(O) {
                    var L = O.type
                      , D = O.tagName;
                    return !!(D === "INPUT" && s[L] && !O.readOnly || D === "TEXTAREA" && !O.readOnly || O.isContentEditable)
                }
                function l(O) {
                ...
                function v(O) {
                    O.metaKey || O.altKey || O.ctrlKey || (a(n.activeElement) && l(n.activeElement),
                    r = !0)
                }
                function p() {
                    r = !1
    ...
    var qa = f( (UF, Fa) => {
        ...
        var ei = window.jQuery
          ...
          , Fn = {
            ...
            intro: function(e, t) {
                ...
                ei(t).triggerHandler(Ze.types.INTRO))
            },
            outro: function(e, t) {
                t.__wf_intro && (t.__wf_intro = null,
                ei(t).triggerHandler(Ze.types.OUTRO))
            }
        };
        Ze.triggers = {};
        Ze.types = {
        ...
        Ze.init = function() {
            ...
            Mn = [],
            ei.extend(Ze.triggers, Fn)
        }
        ;
        Ze.async = function() {
            for (var e in Fn) {
                var t = Fn[e];
                Fn.hasOwnProperty(e) && (Ze.triggers[e] = function(n, r) {
                    Mn.push([t, r])
                }
                )
            }
    ...
    var kn = f( (WF, Xa) => {
        ...
        var uy = window.jQuery
          ...
          , cy = {
            ...
            intro: function(e, t) {
                ti.triggers.intro(e, t),
                ka(t, "COMPONENT_ACTIVE")
            },
            outro: function(e, t) {
                ti.triggers.outro(e, t),
                ka(t, "COMPONENT_INACTIVE")
            }
        };
        qn.triggers = {};
        qn.types = {
    ...
    var ni = f( (BF, Va) => {
        var ly = typeof global == "object" && global && global.Object === Object && global;
        Va.exports = ly
    }
    );
    var ze = f( (HF, Ua) => {
    ...
    var ft = f( (YF, Za) => {
        ...
        function Sy(e) {
            return e == null ? e === void 0 ? Ay : wy : $a && $a in Object(e) ? Ty(e) : by(e)
        }
        Za.exports = Sy
    }
    );
    ...
    var os = f( (ui, si) => {
        ...
        var Rt;
        typeof self < "u" ? Rt = self : typeof window < "u" ? Rt = window : typeof global < "u" ? Rt = global : typeof si < "u" ? Rt = si : Rt = Function("return this")();
        var By = (0,
        Uy.default)(Rt);
        ui.default = By
    }
    ...
    var ci = f(rn => {
        ...
        function cs(e, t, n) {
            ...
            function p(I) {
                ...
                for (var S = s = a, b = 0; b < S.length; b++)
                    S[b]();
                return I
            }
            function y(I) {
    ...
    var je, Ei, Je, EE, mE, Gn, _E, mi = ye( () => {
        "use strict";
        je = {
    ...
    var bE, wE, AE, SE, OE, xE, RE, _i, ys = ye( () => {
        "use strict";
        Xn();
        ({TRANSFORM_MOVE: bE, TRANSFORM_SCALE: wE, TRANSFORM_ROTATE: AE, TRANSFORM_SKEW: SE, STYLE_SIZE: OE, STYLE_FILTER: xE, STYLE_FONT_VARIATION: RE} = Ce),
        _i = {
            [bE]: !0,
            [wE]: !0,
            [AE]: !0,
    ...
    var CE, LE, PE, NE, DE, ME, FE, qE, kE, GE, XE, VE, UE, WE, BE, HE, zE, jE, KE, YE, Es = ye( () => {
        "use strict";
    ...
    var QE, $E, ZE, JE, em, tm, nm, rm, im, om, am, sm, um, cm, lm, fm, dm, pm, hm, gm, vm, ym, Em, mm, _m, Im, Tm, bm, wm, Am, Sm, Om, xm, Rm, Cm, Lm, Pm, Nm, Dm, Mm, Fm, qm, km, Gm, Xm, Vm, Um, Wm, Bm, Hm, zm, jm, Km, Ym, Qm, $m, ms = ye( () => {
        "use strict";
        QE = "|",
        $E = "data-wf-page",
        ZE = "w-mod-js",
    ...
    var Lt = f(me => {
        ...
        var Jm = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function(e) {
            return typeof e
        }
        : function(e) {
        ...
        function Ms(e, t, n, r, i, o) {
            for (var s = arguments.length, a = Array(s > 6 ? s - 6 : 0), u = 6; u < s; u++)
                a[u - 6] = arguments[u];
            return a.length ? Fe.call.apply(Fe, [null, !1, !1, e, t, n, r, i, o].concat(a)) : Fe(!1, !1, e, t, n, r, i, o)
        }
        function Fs(e, t, n, r, i, o) {
            for (var s = arguments.length, a = Array(s > 6 ? s - 6 : 0), u = 6; u < s; u++)
                a[u - 6] = arguments[u];
            return a.length ? Fe.call.apply(Fe, [null, !1, !0, e, t, n, r, i, o].concat(a)) : Fe(!1, !0, e, t, n, r, i, o)
        }
        function qs(e, t, n, r, i, o, s) {
            var a = Wn(e, t);
            a == null && (a = {});
            for (var u = void 0, l = arguments.length, m = Array(l > 7 ? l - 7 : 0), v = 7; v < l; v++)
                m[v - 7] = arguments[v];
            return m.length ? u = Fe.call.apply(Fe, [null, !1, !1, a, n, r, i, o, s].concat(m)) : u = Fe(!1, !1, a, n, r, i, o, s),
            Hn(e, t, u)
        }
        function ks(e, t) {
        ...
        function Gs(e, t, n, r, i, o) {
            for (var s = arguments.length, a = Array(s > 6 ? s - 6 : 0), u = 6; u < s; u++)
                a[u - 6] = arguments[u];
            return a.length ? Fe.call.apply(Fe, [null, !0, !1, e, t, n, r, i, o].concat(a)) : Fe(!0, !1, e, t, n, r, i, o)
        }
        var t_ = {
            clone: Un,
            addLast: As,
    ...
    var Vs, n_, r_, i_, o_, a_, Xs, Us, Ws = ye( () => {
        "use strict";
        Me();
        Vs = de(Lt()),
        {IX2_PREVIEW_REQUESTED: n_, IX2_PLAYBACK_REQUESTED: r_, IX2_STOP_REQUESTED: i_, IX2_CLEAR_REQUESTED: o_} = be,
        a_ = {
            preview: {},
            playback: {},
            stop: {},
    ...
    var Le, s_, u_, c_, l_, f_, d_, p_, h_, g_, v_, Bs, y_, Hs, zs = ye( () => {
        "use strict";
        Me();
        Le = de(Lt()),
        {IX2_SESSION_INITIALIZED: s_, IX2_SESSION_STARTED: u_, IX2_TEST_FRAME_RENDERED: c_, IX2_SESSION_STOPPED: l_, IX2_EVENT_LISTENER_ADDED: f_, IX2_EVENT_STATE_CHANGED: d_, IX2_ANIMATION_FRAME_CHANGED: p_, IX2_ACTION_LIST_PLAYBACK_CHANGED: h_, IX2_VIEWPORT_WIDTH_CHANGED: g_, IX2_MEDIA_QUERIES_DEFINED: v_} = be,
        Bs = {
            active: !1,
            tick: 0,
            eventListeners: [],
            ...
            case f_:
                {
                    ...
                    return (0,
                    Le.set)(e, "eventListeners", n)
                }
            case d_:
                {
                    let {stateKey: n, newState: r} = t.payload;
                    return (0,
                    Le.setIn)(e, ["eventState", n], r)
                }
            case h_:
                {
                    let {actionListId: n, isPlaying: r} = t.payload;
                    return (0,
                    Le.setIn)(e, ["playbackState", n], r)
                }
            case g_:
                {
    ...
    var Zs = f( (P1, $s) => {
        ...
        function A_(e) {
            ...
            if (n < 0)
                return !1;
            var r = t.length - 1;
            return n == r ? t.pop() : w_.call(t, n, 1),
            --this.size,
            !0
        }
        $s.exports = A_
        ...
        function LT(e, t, n, r, i, o) {
            ...
            o.set(t, e); ++v < a; ) {
                var T = e[v]
                  , I = t[v];
                if (r)
                    var S = s ? r(I, T, v, t, e, o) : r(T, I, v, e, t, o);
                if (S !== void 0) {
                    if (S)
                        continue;
                    p = !1;
                ...
                if (y) {
                    if (!OT(t, function(b, R) {
                        if (!xT(y, R) && (T === b || i(T, b, n, r, o)))
                            return y.push(R)
                    })) {
                        p = !1;
                        break
    ...
    var Zn = f( (N2, Kc) => {
        ...
        function Rb(e, t) {
            var n = typeof e;
            return t = t ?? Ob,
            !!t && (n == "number" || n != "symbol" && xb.test(e)) && e > -1 && e % 1 == 0 && e < t
        }
        Kc.exports = Rb
    }
    );
    ...
    var $c = f( (M2, Qc) => {
        var Pb = ft()
          ...
          , ve = {};
        ve[Qb] = ve[$b] = ve[Zb] = ve[Jb] = ve[ew] = ve[tw] = ve[nw] = ve[rw] = ve[iw] = !0;
        ve[Mb] = ve[Fb] = ve[Kb] = ve[qb] = ve[Yb] = ve[kb] = ve[Gb] = ve[Xb] = ve[Vb] = ve[Ub] = ve[Wb] = ve[Bb] = ve[Hb] = ve[zb] = ve[jb] = !1;
        function ow(e) {
    ...
    var Pi = f( (k2, ol) => {
        ...
        function Iw(e, t) {
            var n = gw(e)
              ...
              , u = a.length;
            for (var l in e)
                (t || _w.call(e, l)) && !(s && (l == "length" || i && (l == "offset" || l == "parent") || o && (l == "buffer" || l == "byteLength" || l == "byteOffset") || yw(l, u))) && a.push(l);
            return a
        }
        ol.exports = Iw
    }
    ...
    var nr = f( (V2, cl) => {
        ...
        function Cw(e) {
            ...
            for (var n in Object(e))
                Rw.call(e, n) && n != "constructor" && t.push(n);
            return t
        }
        cl.exports = Cw
    }
        ...
        function Hw(e, t, n, r, i, o) {
            ...
            for (var S = s; ++v < u; ) {
                ...
                var b = e[p]
                  , R = t[p];
                if (r)
                    var O = s ? r(R, b, p, t, e, o) : r(b, R, p, e, t, o);
    ...
    var rr = f( (Q2, Cl) => {
        var Di = El()
          ...
          , c0 = kt(ki)
          , _t = Rl;
        (Di && _t(new Di(new ArrayBuffer(1))) != xl || Mi && _t(new Mi) != wl || Fi && _t(Fi.resolve()) != Al || qi && _t(new qi) != Sl || ki && _t(new ki) != Ol) && (_t = function(e) {
            var t = Rl(e)
    ...
    var Xi = f( (Z2, Vl) => {
        ...
        function Xl(e, t, n, r, i) {
            return e === t ? !0 : e == null || t == null || !Gl(e) && !Gl(t) ? e !== e && t !== t : y0(e, t, n, r, Xl, i)
        }
        Vl.exports = Xl
    }
    );
        ...
        function T0(e, t, n, r) {
            ...
            for (; ++i < o; ) {
                ...
                if (s && a[2]) {
                    ...
                    if (r)
                        var p = r(l, m, u, e, t, v);
                    if (!(p === void 0 ? m0(m, l, _0 | I0, r, v) : p))
                        return !1
                }
            }
            return !0
    ...
    var or = f( (oq, $l) => {
        ...
        function V0(e, t) {
            if (q0(e))
                return !1;
            var n = typeof e;
            return n == "number" || n == "symbol" || n == "boolean" || e == null || k0(e) ? !0 : X0.test(e) || !G0.test(e) || t != null && e in Object(t)
        }
        $l.exports = V0
    }
    );
    var ef = f( (aq, Jl) => {
        ...
        function Wi(e, t) {
            ...
            return n.cache = new (Wi.Cache || Zl),
            n
        }
        Wi.Cache = Zl;
        Jl.exports = Wi
    ...
    var Sf = f( (mq, Af) => {
        var OA = Xi()
          ...
          , MA = 2;
        function FA(e, t) {
            return CA(e) && LA(t) ? PA(NA(e), t) : function(n) {
                var r = xA(n, e);
    ...
    var pt = f( (wq, Nf) => {
        var zA = Yl()
          ...
          , QA = Pf();
        function $A(e) {
            return typeof e == "function" ? e : e == null ? KA : typeof e == "object" ? YA(e) ? jA(e[0], e[1]) : zA(e) : QA(e)
        }
        Nf.exports = $A
    }
    );
    ...
    var $f, Ke, lr, xS, Qi, ht, Qf, fr, dr = ye( () => {
        "use strict";
        $f = de(Yi()),
        Ke = typeof window < "u",
        lr = (e, t) => Ke ? e() : t,
        ...
        rd.exports = function(t, n, r, i) {
            ...
            if (t !== n || r !== i)
                for (var s = 0; s < vn; ++s)
                    o[s] = hr(s * pr, t, r);
            function a(u) {
                for (var l = 0, m = 1, v = vn - 1; m !== v && o[m] <= u; ++m)
                    l += pr;
                --m;
            ...
            return function(l) {
                return t === n && r === i ? l : l === 0 ? 0 : l === 1 ? 1 : hr(a(l), n, i)
            }
        }
    }
    );
    ...
    function _O(e, t, n) {
        return t === 0 ? 0 : t === 1 ? 1 : mn(n ? t > 0 ? n(t) : t : t > 0 && e && En[e] ? En[e](t) : t)
    }
    var id, Ji = ye( () => {
        "use strict";
        Zi();
    ...
    var Xt, Fq, IO, qq, TO, bO, wO, AO, SO, OO, xO, RO, CO, LO, PO, ad, NO, DO, MO, cd = ye( () => {
        "use strict";
        Xt = de(Lt());
        Me();
        ({HTML_ELEMENT: Fq, PLAIN_OBJECT: IO, ABSTRACT_NODE: qq, CONFIG_X_VALUE: TO, CONFIG_Y_VALUE: bO, CONFIG_Z_VALUE: wO, CONFIG_VALUE: AO, CONFIG_X_UNIT: SO, CONFIG_Y_UNIT: OO, CONFIG_Z_UNIT: xO, CONFIG_UNIT: RO} = Se),
        {IX2_SESSION_STOPPED: CO, IX2_INSTANCE_ADDED: LO, IX2_ELEMENT_STATE_CHANGED: PO} = be,
        ad = {},
        NO = "refState",
        DO = (e=ad, t={}) => {
            switch (t.type) {
            ...
            case LO:
                {
                    let {elementId: n, element: r, origin: i, actionItem: o, refType: s} = t.payload
                      ...
                      , u = e;
                    return (0,
                    Xt.getIn)(u, [n, r]) !== r && (u = sd(u, r, s, n, o)),
                    eo(u, n, a, i, o)
                }
            case PO:
                {
        ...
        var zO = e => document.querySelector(`[data-w-id="${e}"]`)
          ...
          , $O = (e, t) => {
            ...
            if (e) {
                let o = Object.keys(e)
                  , s = KO(r, o);
                return s.length ? s.reduce( (u, l) => (u[l] = fd[l],
                u), e) : e
            }
            return r.reduce( (o, s) => (o[s] = fd[s],
            o), {})
        }
          , ZO = e => e.value
          , JO = (e, t) => {
                    ...
                    if (v != null) {
                        ...
                        ro in a || io in a) {
                            let p = l.layout
                              , y = a[ro] ?? p.fit
                              , T = a[io] ?? p.alignment;
                            (y !== p.fit || T !== p.alignment) && (l.layout = p.copyWith({
                                fit: y,
                                alignment: T
                            }))
                        }
    ...
    var so = f(ao => {
        ...
        function dx(e) {
            let t, n, r, i = 1, o = e.replace(/\s/g, "").toLowerCase(), a = (typeof hd[o] == "string" ? hd[o].toLowerCase() : null) || o;
            if (a.startsWith("#")) {
                let u = a.substring(1);
                ...
                i = parseFloat(u[3]);
                let p = (1 - Math.abs(2 * v - 1)) * m, y = p * (1 - Math.abs(l / 60 % 2 - 1)), T = v - p / 2, I, S, b;
                l >= 0 && l < 60 ? (I = p,
                S = y,
                b = 0) : l >= 60 && l < 120 ? (I = y,
                S = p,
                ...
                let u = a.match(/hsl\(([^)]+)\)/)[1].split(","), l = parseFloat(u[0]), m = parseFloat(u[1].replace("%", "")) / 100, v = parseFloat(u[2].replace("%", "")) / 100, p = (1 - Math.abs(2 * v - 1)) * m, y = p * (1 - Math.abs(l / 60 % 2 - 1)), T = v - p / 2, I, S, b;
                l >= 0 && l < 60 ? (I = p,
                S = y,
                b = 0) : l >= 60 && l < 120 ? (I = y,
                S = p,
    ...
    var yd = f(co => {
        ...
        var Ox = new Map([[gr.ActionTypeConsts.PLUGIN_LOTTIE, {
            ...bx
    ...
    var lo, Tt, fo, po, xx, ho, Rx, go, vo, yo = ye( () => {
        "use strict";
        dr();
        lo = de(yd());
        Tt = e => t => {
    ...
    function Ao({config: e, event: t, eventTarget: n, elementRoot: r, elementApi: i}) {
        if (!i)
            throw new Error("IX2 missing elementApi");
        let {targets: o} = e;
        if (Array.isArray(o) && o.length > 0)
            return o.reduce( (q, A) => q.concat(Ao({
                config: {
                    target: A
                },
                event: t,
        ...
        let {getValidDocument: s, getQuerySelector: a, queryDocument: u, getChildElements: l, getSiblingElements: m, matchSelector: v, elementContains: p, isSiblingNode: y} = i
          , {target: T} = e;
        if (!T)
            return [];
        let {id: I, objectId: S, selector: b, selectorGuids: R, appliesTo: O, useEventTarget: L} = Wd(T);
        if (S)
            return [yr.has(S) ? yr.get(S) : yr.set(S, {}).get(S)];
        if (O === Ei.PAGE) {
            let q = s(I);
            return q ? [q] : []
        }
        let C = (t?.action?.config?.affectedElements ?? {})[I || b] || {}, W = !!(C.id || C.selector), H, z, Q, te = t && a(Wd(t.target));
        if (W ? (H = C.limitAffectedElements,
        z = te,
        Q = a(C)) : z = Q = a({
            id: I,
            selector: b,
        ...
        t && L) {
            ...
            if (Q) {
                if (L === mR)
                    return u(Q).filter(A => q.some(M => p(A, M)));
                if (L === Vd)
                    return u(Q).filter(A => q.some(M => p(M, A)));
                if (L === Ud)
                    return u(Q).filter(A => q.some(M => y(M, A)))
            }
            return q
        }
        return z == null || Q == null ? [] : Ke && r ? u(Q).filter(q => r.contains(q)) : H === Vd ? u(z, Q) : H === ER ? l(u(z)).filter(v(Q)) : H === Ud ? m(u(z)).filter(v(Q)) : u(Q)
    }
    ...
    function NR(e, t={}, n={}, r, i) {
        ...
        case $d:
            return {
                value: (0,
                st.default)(parseFloat(o(e, mr)), 1)
            };
        case Ht:
            {
                let a = o(e, tt), u = o(e, nt), l, m;
                return r.config.widthUnit === gt ? l = Bd.test(a) ? parseFloat(a) : parseFloat(n.width) : l = (0,
                st.default)(parseFloat(a), parseFloat(n.width)),
                r.config.heightUnit === gt ? m = Bd.test(u) ? parseFloat(u) : parseFloat(n.height) : m = (0,
                st.default)(parseFloat(u), parseFloat(n.height)),
                {
                    widthValue: l,
                    heightValue: m
                }
    ...
    function BR(e, t, n, r, i) {
        let o = WR.map(a => {
            let u = So[a]
              , {xValue: l=u.xValue, yValue: m=u.yValue, zValue: v=u.zValue, xUnit: p="", yUnit: y="", zUnit: T=""} = t[a] || {};
            switch (a) {
            case Ut:
    ...
    function HR(e, t, n, r) {
        let i = (0,
        Ir.default)(t, (s, a, u) => `${s} ${u}(${a}${UR(u, n)})`, "")
          , {setStyle: o} = r;
        bt(e, _n, r),
        o(e, _n, i)
    }
    ...
    function jR({actionTypeId: e}, {xValue: t, yValue: n, zValue: r}) {
        return e === Ut && r !== void 0 || e === Wt && r !== void 0 || e === Bt && (t !== void 0 || n !== void 0)
    }
    function $R(e, t) {
        let n = e.exec(t);
        return n ? n[1] : ""
    ...
    function tp(e, t, n) {
        ...
        let {getStyle: i, setStyle: o} = n
          , s = i(e, Vt);
        !s || s.indexOf(r) === -1 || o(e, Vt, s.split(Tn).map(Zd).filter(a => a !== r).join(Tn))
    }
    ...
    function nC(e, t, n) {
        ...
        if (o === Ht) {
            let {config: s} = t;
            s.widthUnit === gt && r(e, tt, ""),
            s.heightUnit === gt && r(e, nt, "")
        }
        i(e, Vt) && np({
            effect: tp,
            actionTypeId: o,
    ...
    function aC(e, {basedOn: t}) {
        return e === je.SCROLLING_IN_VIEW && (t === Je.ELEMENT || t == null) || e === je.MOUSE_MOVE && t === Je.ELEMENT
    }
    function sC(e, t) {
        return e + _R + t
    }
    ...
    var st, Ir, Er, Tr, jd, aR, sR, uR, cR, lR, fR, dR, pR, hR, gR, mr, _n, In, tt, nt, Kd, vR, yR, Vd, ER, Ud, mR, _r, Vt, gt, Tn, _R, Io, Yd, To, bo, Qd, Ut, Wt, Bt, bn, $d, wn, An, Ht, zt, jt, Kt, br, IR, Zd, wo, Jd, yr, bR, AR, xR, Bd, LR, PR, DR, MR, FR, So, XR, VR, UR, WR, KR, YR, QR, np, op = ye( () => {
        "use strict";
        st = de(_d()),
        Ir = de(Dd()),
        Er = de(kd()),
        ...
        yo();
        dr();
        ({BACKGROUND: aR, TRANSFORM: sR, TRANSLATE_3D: uR, SCALE_3D: cR, ROTATE_X: lR, ROTATE_Y: fR, ROTATE_Z: dR, SKEW: pR, PRESERVE_3D: hR, FLEX: gR, OPACITY: mr, FILTER: _n, FONT_VARIATION_SETTINGS: In, WIDTH: tt, HEIGHT: nt, BACKGROUND_COLOR: Kd, BORDER_COLOR: vR, COLOR: yR, CHILDREN: Vd, IMMEDIATE_CHILDREN: ER, SIBLINGS: Ud, PARENT: mR, DISPLAY: _r, WILL_CHANGE: Vt, AUTO: gt, COMMA_DELIMITER: Tn, COLON_DELIMITER: _R, BAR_DELIMITER: Io, RENDER_TRANSFORM: Yd, RENDER_GENERAL: To, RENDER_STYLE: bo, RENDER_PLUGIN: Qd} = Se),
        {TRANSFORM_MOVE: Ut, TRANSFORM_SCALE: Wt, TRANSFORM_ROTATE: Bt, TRANSFORM_SKEW: bn, STYLE_OPACITY: $d, STYLE_FILTER: wn, STYLE_FONT_VARIATION: An, STYLE_SIZE: Ht, STYLE_BACKGROUND_COLOR: zt, STYLE_BORDER: jt, STYLE_TEXT_COLOR: Kt, GENERAL_DISPLAY: br, OBJECT_VALUE: IR} = Ce,
        Zd = e => e.trim(),
        wo = Object.freeze({
            [zt]: Kd,
            [jt]: vR,
        ...
        xR = (e, t) => e === t;
        Bd = /px/,
        LR = (e, t) => t.reduce( (n, r) => (n[r.type] == null && (n[r.type] = XR[r.type]),
        n), e || {}),
        PR = (e, t) => t.reduce( (n, r) => (n[r.type] == null && (n[r.type] = VR[r.type] || r.defaultValue || 0),
        n), e || {});
        ...
        YR = /^rgb/,
        QR = RegExp(`rgba?${KR}`);
        np = ({effect: e, actionTypeId: t, elementApi: n}) => r => {
            switch (t) {
            case Ut:
            case Wt:
            case Bt:
    ...
    var Ar, ut, EC, mC, _C, IC, TC, bC, wr, sp, wC, AC, xo, SC, OC, xC, RC, up, cp = ye( () => {
        "use strict";
        Me();
        Ar = de(wt()),
        ut = de(Lt()),
        {IX2_RAW_DATA_IMPORTED: EC, IX2_SESSION_STOPPED: mC, IX2_INSTANCE_ADDED: _C, IX2_INSTANCE_STARTED: IC, IX2_INSTANCE_REMOVED: TC, IX2_ANIMATION_FRAME_CHANGED: bC} = be,
        {optimizeFloat: wr, applyEasing: sp, createBezierEasing: wC} = Ar.IX2EasingUtils,
        {RENDER_GENERAL: AC} = Se,
        {getItemConfigByKey: xo, getRenderType: SC, getStyleProp: OC} = Ar.IX2VanillaUtils,
        xC = (e, t) => {
            let {position: n, parameterId: r, actionGroups: i, destinationKeys: o, smoothing: s, restingValue: a, actionTypeId: u, customEasingFn: l, skipMotion: m, skipToValue: v} = e
        ...
        ,
        RC = (e, t) => {
            let {active: n, origin: r, start: i, immediate: o, renderType: s, verbose: a, actionItem: u, destination: l, destinationKeys: m, pluginDuration: v, instanceDelay: p, customEasingFn: y, skipMotion: T} = e
              , I = u.config.easing
            ...
            if (n && r) {
                ...
                if (a) {
                    ...
                    e = (0,
                    ut.set)(e, "verboseTimeElapsed", z * Q)
                }
                if (O < 0)
                    return e;
        ...
        up = (e=Object.freeze({}), t) => {
            ...
            case _C:
                {
                    let {instanceId: n, elementId: r, actionItem: i, eventId: o, eventTarget: s, eventStateKey: a, actionListId: u, groupIndex: l, isCarrier: m, origin: v, destination: p, immediate: y, verbose: T, continuous: I, parameterId: S, actionGroups: b, smoothing: R, restingValue: O, pluginInstance: L, pluginDuration: D, instanceDelay: C, skipMotion: W, skipToValue: H} = t.payload
                      , {actionTypeId: z} = i
                      , Q = SC(z)
                      , te = OC(Q, z)
                    ...
                    ut.set)(e, n, {
                        ...
                        skipMotion: W,
                        skipToValue: H,
                        customEasingFn: Array.isArray(A) && A.length === 4 ? wC(A) : void 0
                    })
                }
            case IC:
                {
    ...
    var CC, LC, PC, lp, fp = ye( () => {
        "use strict";
        Me();
        ({IX2_RAW_DATA_IMPORTED: CC, IX2_SESSION_STOPPED: LC, IX2_PARAMETER_CHANGED: PC} = be),
        lp = (e={}, t) => {
            switch (t.type) {
            case CC:
    ...
    var Cp = f( (Tk, Rp) => {
        ...
        function uL(e) {
            for (var t = Tp.lastIndex = 0; Tp.test(e); )
                ++t;
            return t
        }
        Rp.exports = uL
    ...
    var Vp = f( (xk, Xp) => {
        ...
        function CL(e, t, n) {
            var r = e[t];
            (!(RL.call(e, t) && OL(r, n)) || n === void 0 && !(t in e)) && SL(e, t, n)
        }
        Xp.exports = CL
    }
    );
    ...
    var uh = f( (kk, sh) => {
        ...
        function xP(e) {
            if (e == null)
                return !0;
            if (_P(e) && (mP(e) || typeof e == "string" || typeof e.splice == "function" || IP(e) || bP(e) || EP(e)))
                return !e.length;
            var t = yP(e);
            if (t == wP || t == AP)
                return !e.size;
    ...
    var Ih = f( (Bk, _h) => {
        var WP = et()
          ...
          , zP = Math.min;
        function jP(e, t, n) {
            var r, i, o, s, a, u, l = 0, m = !1, v = !1, p = !0;
            if (typeof e != "function")
    ...
    var bh = f( (Hk, Th) => {
        ...
        function $P(e, t, n) {
            ...
            return YP(n) && (r = "leading"in n ? !!n.leading : r,
    ...
    var wh, ZP, JP, eN, tN, nN, rN, iN, oN, aN, sN, uN, cN, lN, fN, dN, pN, hN, gN, vN, yN, EN, Do, Mo, Fo, qo, mN, _N, IN, TN, Sr, bN, ko, Or, Qt, Go, xr, Xo, Vo, $t, Uo, Wo, Rr = ye( () => {
        ...
        _N = ({actionTypeId: e=Ce.GENERAL_START_ACTION, actionListId: t, actionItemId: n, eventId: r, allowEvents: i, immediate: o, testManual: s, verbose: a, rawData: u}) => ({
            type: rN,
            payload: {
                actionTypeId: e,
                actionListId: t,
    ...
    function jo(e) {
        return e != null && typeof e == "object" ? e instanceof Element ? wN : AN : null
    }
    var Oh, Bo, Sh, wN, AN, xh, Sn, Rh = ye( () => {
        "use strict";
        Oh = de(wt());
        Me();
        ({ELEMENT_MATCHES: Bo} = Oh.IX2BrowserSupport),
        {IX2_ID_DELIMITER: Sh, HTML_ELEMENT: wN, PLAIN_OBJECT: AN, WF_PAGE: xh} = Se;
    ...
    var Xh = f( (Zk, Gh) => {
        ...
        function kh(e, t, n, r, i) {
            ...
            i || (i = []); ++o < s; ) {
                var a = e[o];
                t > 0 && n(a) ? t > 1 ? kh(a, t - 1, n, r, i) : WN(i, a) : r || (i[i.length] = a)
            }
            return i
        }
        Gh.exports = kh
    ...
    var jh = f( (tG, zh) => {
        var KN = Bh()
          , Hh = Math.max;
        function YN(e, t, n) {
            return t = Hh(t === void 0 ? e.length - 1 : t, 0),
            function() {
                for (var r = arguments, i = -1, o = Hh(r.length - t, 0), s = Array(o); ++i < o; )
                    s[i] = r[t + i];
                i = -1;
    ...
    var Qo = f( (fG, gg) => {
        ...
        function ED(e) {
            for (var t = e.name + "", n = hg[t], r = yD.call(hg, t) ? n.length : 0; r--; ) {
                var i = n[r]
                  , o = i.func;
                if (o == null || o == e)
                    return i.name
        ...
        function jD(e) {
            return GD(function(t) {
                ...
                for (r = s ? r : n; ++r < n; ) {
                    ...
                    u && Og(u[0]) && u[1] == (HD | WD | BD | zD) && !u[4].length && u[9] == 1 ? s = s[$o(u[0])].apply(s, u[3]) : s = o.length == 1 && Og(o) ? s[a]() : s.thru(o)
                }
                return function() {
                    var l = arguments
                      , m = l[0];
                    if (s && l.length == 1 && VD(m))
    ...
    var Bg, Hg, zg, jg, JD, eM, tM, nM, rM, iM, oM, aM, sM, uM, cM, lM, fM, dM, pM, Kg, Yg, hM, gM, vM, Qg, yM, EM, $g, mM, Jo, Zg, Fg, qg, Jg, xn, _M, rt, ev, IM, qe, Ye, Rn, tv, ea, kg, ta, TM, On, bM, wM, AM, nv, Gg, SM, Xg, OM, xM, RM, Vg, Fr, qr, Ug, Wg, rv, iv = ye( () => {
        "use strict";
        Bg = de(Lg()),
        Hg = de(sr()),
        zg = de(Mg());
        ...
        qe = ({store: e, event: t, element: n, eventStateKey: r}, i) => {
            ...
            return l && Zt({
                ...
                actionListId: (0,
                Hg.default)(l, "action.config.actionListId")
            }),
            Zt({
                store: e,
                eventId: s,
        ...
        On = ( () => {
            ...
            return () => ({
                ...
                stiffScrollTop: (0,
                zg.default)(e ? window.pageYOffset : n.scrollTop, 0, n.scrollHeight - window.innerHeight),
        ...
        ,
        OM = (e, t) => e.left > t.left && e.left < t.right && e.top > t.top && e.top < t.bottom,
        xM = e => (t, n) => {
            let r = {
        ...
        Fr = (e=!0) => ({
            ...tv,
            handler: Ye(e ? rt : xn, nv( (t, n) => n.isActive ? Rn.handler(t, n) : n))
        }),
        qr = (e=!0) => ({
            ...tv,
            handler: Ye(e ? rt : xn, nv( (t, n) => n.isActive ? n : Rn.handler(t, n)))
        }),
        Ug = {
            ...ta,
            handler: SM( (e, t) => {
                let {elementVisible: n} = t
                  ...
                  , {ixData: o} = i.getState()
                  , {events: s} = o;
                return !s[r.action.config.autoStopEventId] && t.triggered ? t : r.eventTypeId === Yg === n ? (qe(e),
                {
                    ...t,
                    triggered: !0
                }) : t
        ...
        rv = {
            ...
            [JD]: {
                types: "click",
                handler: Ye(rt, Vg( (e, {clickCount: t}) => {
                    IM(e) ? t === 1 && qe(e) : qe(e)
                }
                ))
            },
            ...
            [pM]: {
                ...
                handler: ({store: e, element: t, eventConfig: n, nativeEvent: r, eventStateKey: i}, o={
                    ...
                    let {basedOn: s, selectedAxis: a, continuousParameterGroupId: u, reverse: l, restingState: m=0} = n
                      , {clientX: v=o.clientX, clientY: p=o.clientY, pageX: y=o.pageX, pageY: T=o.pageY} = r
                      , I = a === "X_AXIS"
                      , S = r.type === "mouseout"
                      , b = m / 100
                      , R = u
                    ...
                    case Je.PAGE:
                        {
                            let {scrollLeft: L, scrollTop: D, scrollWidth: C, scrollHeight: W} = On();
                    ...
                    return S && (b > 1 - Wg || b < Wg) && (b = Math.round(b)),
                    (s !== Je.ELEMENT || O || O !== o.elementHovered) && (b = l ? 1 - b : b,
                    e.dispatch(Qt(R, b))),
                    {
                        elementHovered: O,
                        clientX: v,
            ...
            [vM]: {
                ...
                handler: ({element: e, store: t, eventConfig: n, eventStateKey: r}, i={
                    ...
                    let {scrollLeft: o, scrollTop: s, scrollWidth: a, scrollHeight: u, clientHeight: l} = On()
                      , {basedOn: m, selectedAxis: v, continuousParameterGroupId: p, startsEntering: y, startsExiting: T, addEndOffset: I, addStartOffset: S, addOffsetValue: b=0, endOffsetValue: R=0} = n
                      , O = v === "X_AXIS";
                    if (m === Je.VIEWPORT) {
                        let L = O ? o / a : s / u;
                        return L !== i.scrollPercent && t.dispatch(Qt(p, L)),
                        {
                            scrollPercent: L
                        }
                    } else {
                        ...
                        return A !== i.scrollPercent && t.dispatch(Qt(L, A)),
                        {
                            scrollPercent: A
                        }
                    }
    ...
    function JM(e, t) {
        let {actionTypeId: n, actionListId: r, actionItemId: i, eventId: o, allowEvents: s, immediate: a, testManual: u, verbose: l=!0} = e
          , {rawData: m} = e;
        if (r && i && m && a) {
    ...
    function Wr({store: e, rawData: t, allowEvents: n, testManual: r}) {
        ...
        n && (sF(e),
        nF(),
        e.getState().ixSession.hasDefinedMediaQueries && QM(e)),
        e.dispatch(Fo()),
        rF(e, r))
    }
    function nF() {
    ...
    function rF(e, t) {
        let n = r => {
            ...
            i.active && (e.dispatch(Or(r, o)),
            t ? $M(e, n) : requestAnimationFrame(n))
        }
        ;
    ...
    function oF({store: e, eventStateKey: t, eventTarget: n, eventId: r, eventConfig: i, actionListId: o, parameterGroup: s, smoothing: a, restingValue: u}) {
        ...
        S.forEach( ({element: L, key: D}) => {
            let C = I[D]
              , W = (0,
            ct.default)(C, "[0].actionItems[0]", {})
              , {actionTypeId: H} = W
              , Q = (H === Ce.PLUGIN_RIVE ? (W.config?.target?.selectorGuids || []).length === 0 : Ur(H)) ? aa(H)(L, W) : null
              , te = oa({
                element: L,
                actionItem: W,
                elementApi: Pe
    ...
    function pF({logic: e, store: t, events: n}) {
        ...
        Jt.default)(a, (v, p) => {
            ...
            T.actionTypeId === Ce.GENERAL_CONTINUOUS_ACTION && (Array.isArray(y.config) ? y.config : [y.config]).forEach(O => {
                let {continuousParameterGroupId: L} = O
                  , D = (0,
                ct.default)(s, `${b}.continuousParameterGroups`, [])
                  , C = (0,
                sv.default)(D, ({id: z}) => z === L)
                  , W = (O.smoothing || 0) / 100
            ...
            (T.actionTypeId === Ce.GENERAL_START_ACTION || ra(T.actionTypeId)) && yv({
                store: t,
                actionListId: b,
                eventId: I
            })
        ...
        let u = v => {
            ...
            fF(a, (y, T, I) => {
                ...
                ;
                R.actionTypeId === Ce.GENERAL_CONTINUOUS_ACTION ? (Array.isArray(S.config) ? S.config : [S.config]).forEach(L) : L()
            }
            )
        }
          , l = (0,
    ...
    function hF(e) {
        ...
        for (let r in e) {
            let {eventTypeId: i, target: o} = e[r]
              , s = Ho(o);
            t[s] || (i === je.MOUSE_CLICK || i === je.MOUSE_SECOND_CLICK) && (t[s] = !0,
    ...
    function yv({store: e, actionListId: t, eventId: n}) {
        ...
        if (u && u.useFirstGroupAsInitialState) {
            ...
            ct.default)(u, "actionItemGroups[0].actionItems", [])
              , m = (0,
            ct.default)(a, "mediaQueries", r.mediaQueryKeys);
            if (!Vr(m, i.mediaQueryKey))
                return;
            l.forEach(v => {
    ...
    function Zt({store: e, eventId: t, eventTarget: n, eventStateKey: r, actionListId: i}) {
    ...
    function Cn({store: e, eventId: t, eventTarget: n, eventStateKey: r, actionListId: i, groupIndex: o=0, immediate: s, verbose: a}) {
    ...
    function sa(e) {
        let {store: t, computedStyle: n, ...r} = e, {element: i, actionItem: o, immediate: s, pluginInstance: a, continuous: u, restingValue: l, eventId: m} = r, v = !u, p = NM(), {ixElements: y, ixSession: T, ixData: I} = t.getState(), S = PM(y, i), {refState: b} = y[S] || {}, R = jo(i), O = T.reducedMotion && _i[o.actionTypeId], L;
        if (O && u)
    ...
    function gF(e, t) {
        ...
        e.dispatch(xr(t, 0)),
        e.dispatch(Or(performance.now(), n));
        let {ixInstances: r} = e.getState();
        _v(r[t], e)
    }
    function _v(e, t) {
        let {active: n, continuous: r, complete: i, elementId: o, actionItem: s, actionTypeId: a, renderType: u, current: l, groupIndex: m, eventId: v, eventTarget: p, eventStateKey: y, actionListId: T, isCarrier: I, styleProp: S, verbose: b, pluginInstance: R} = e
    ...
    var sv, ct, uv, cv, lv, fv, Jt, dv, kr, CM, ra, ia, Gr, pv, LM, ov, Xr, PM, oa, At, NM, DM, hv, MM, FM, qM, kM, GM, XM, Vr, VM, UM, WM, BM, HM, Ur, aa, zM, av, jM, KM, uF, lF, fF, dF, na = ye( () => {
        "use strict";
        sv = de(Yi()),
        ct = de(sr()),
        uv = de(Dp()),
        ...
        CM = Object.keys(Gn),
        ra = e => CM.includes(e),
        {COLON_DELIMITER: ia, BOUNDARY_SELECTOR: Gr, HTML_ELEMENT: pv, RENDER_GENERAL: LM, W_MOD_IX: ov} = Se,
        {getAffectedElements: Xr, getElementId: PM, getDestinationValues: oa, observeStore: At, getInstanceId: NM, renderHTMLElement: DM, clearAllStyles: hv, getMaxDurationItemIndex: MM, getComputedStyle: FM, getInstanceOrigin: qM, reduceListToGroup: kM, shouldNamespaceEventParameter: GM, getNamespacedParameterId: XM, shouldAllowMediaQuery: Vr, cleanupHTMLElement: VM, clearObjectCache: UM, stringifyTarget: WM, mediaQueriesEqual: BM, shallowEqual: HM} = kr.IX2VanillaUtils,
        {isPluginType: Ur, createPluginInstance: aa, getPluginDuration: zM} = kr.IX2VanillaPlugins,
    ...
    var xv = f( (CG, Ov) => {
        ...
        var Av = Xe()
          , Sv = wv();
        Sv.setEnv(Av.env);
        Av.define("ix2", Ov.exports = function() {
            return Sv
        }
        )
    }
    ...
    var Cv = f( (LG, Rv) => {
        "use strict";
        var en = Xe();
        en.define("links", Rv.exports = function(e, t) {
            var n = {}, r = e(window), i, o = en.env(), s = window.location, a = document.createElement("a"), u = "w--current", l = /index\.(html|php)$/, m = /\/$/, v, p;
            ...
            function T(b) {
                if (!b.getAttribute("hreflang")) {
                    ...
                    !(R.indexOf(":") >= 0)) {
                        ...
                        if (!(R === "#" || R === "")) {
                            var D = a.href === s.href || R === p || l.test(R) && m.test(p);
                            S(O, u, D)
                        }
                    }
                }
    ...
    var Pv = f( (PG, Lv) => {
        "use strict";
        var zr = Xe();
        zr.define("scroll", Lv.exports = function(e) {
            var t = {
            ...
            function O(q, A) {
                ...
                case "add":
                    M = q.attr("tabindex"),
                    M ? q.attr("data-wf-tabindex-swap", M) : q.attr("tabindex", "-1");
                    break;
                case "remove":
            ...
            function L(q) {
                ...
                if (!(zr.env("design") || window.$.mobile && /(?:^|\s)ui-link(?:$|\s)/.test(A.className))) {
                    var M = S(A) ? A.hash : "";
                    if (M !== "") {
                        var j = e(M);
                        j.length && (q && (q.preventDefault(),
                        q.stopPropagation()),
                        D(M, q),
            ...
            function D(q) {
                if (n.hash !== q && r && r.pushState && !(zr.env.chrome && n.protocol === "file:")) {
            ...
            function H(q, A, M) {
                if (R())
                    return 0;
                var j = 1;
                return s.add(q).each(function(B, ne) {
    ...
    var Dv = f( (NG, Nv) => {
        "use strict";
        var wF = Xe();
        wF.define("touch", Nv.exports = function(e) {
            var t = {}
            ...
            ;
            function r(o) {
                var s = !1, a = !1, u = Math.min(Math.round(window.innerWidth * .04), 40), l, m;
                ...
                function p(S) {
                    if (s) {
                        ...
                        var b = S.touches
                          ...
                          , O = R - m;
                        m = R,
                        Math.abs(O) > u && n && String(n()) === "" && (i("swipe", S, {
    ...
    var qv = f( (MG, Fv) => {
        ...
        ;
        jr.define("forms", Fv.exports = function(e, t) {
            let n = "TURNSTILE_LOADED";
            var r = {}, i = e(document), o, s = window.location, a = window.XDomainRequest && !window.atob, u = ".w-form", l, m = /e(-)?mail/i, v = /^\S+@\S+$/, p = window.alert, y = jr.env(), T, I, S;
            let b = i.find("[data-turnstile-sitekey]").data("turnstile-sitekey"), R;
            ...
            function C() {
                b && (R = document.createElement("script"),
            ...
            function W(h, g) {
                ...
                var oe = G.form.attr("aria-label") || G.form.attr("data-name") || "Form";
                G.done.attr("aria-label") || G.form.attr("aria-label", oe),
                G.done.attr("tabindex", "-1"),
                G.done.attr("role", "region"),
                G.done.attr("aria-label") || G.done.attr("aria-label", oe + " success"),
                G.fail.attr("tabindex", "-1"),
                G.fail.attr("role", "region"),
                G.fail.attr("aria-label") || G.fail.attr("aria-label", oe + " failure");
            ...
            function H() {
                ...
                let h = ".w-checkbox-input"
                  ...
                  , se = [["checkbox", h], ["radio", g]];
                i.on("change", u + ' form input[type="checkbox"]:not(' + h + ")", K => {
                    e(K.target).siblings(h).toggleClass(X)
                }
                ),
                i.on("change", u + ' form input[type="radio"]', K => {
                    e(`input[name="${K.target.name}"]:not(${h})`).map( (F, Y) => e(Y).siblings(g).removeClass(X));
                    let d = e(K.target);
                    d.hasClass("w-radio-input") || d.siblings(g).addClass(X)
                }
                ),
                se.forEach( ([K,d]) => {
                    i.on("focus", u + ` form input[type="${K}"]:not(` + d + ")", F => {
                        e(F.target).siblings(d).addClass(G),
                        e(F.target).filter(oe).siblings(d).addClass(Z)
                    }
                    ),
                    i.on("blur", u + ` form input[type="${K}"]:not(` + d + ")", F => {
            ...
            function te(h, g) {
                var X = null;
                return g = g || {},
                h.find(':input:not([type="submit"]):not([type="file"])').each(function(G, Z) {
                    var oe = e(Z)
                      , se = oe.attr("type")
                      , K = oe.attr("data-name") || oe.attr("name") || "Field " + (G + 1);
                    ...
                    if (se === "checkbox")
                        ...
                        if (g[K] === null || typeof g[K] == "string")
                            return;
                        d = h.find('input[name="' + oe.attr("name") + '"]:checked').val() || null
                    }
            ...
            function q(h) {
                var g = {};
                return h.find(':input[type="file"]').each(function(X, G) {
                    var Z = e(G)
                      , oe = Z.attr("data-name") || Z.attr("name") || "File " + (X + 1)
                      , se = Z.attr("data-value");
                    typeof se == "string" && (se = e.trim(se)),
                    g[oe] = se
                }),
                g
            }
            ...
            function j(h, g, X, G) {
                var Z = null;
                return g === "password" ? Z = "Passwords cannot be submitted." : h.attr("required") ? G ? m.test(h.attr("type")) && (v.test(G) || (Z = "Please enter a valid email address for: " + X)) : Z = "Please fill out the required field: " + X : X === "g-recaptcha-response" && !G && (Z = "Please confirm you\u2019re not a robot."),
                Z
            }
            function B(h) {
                le(h),
            ...
            function Ie(h, g) {
                ...
                function P(ee) {
                    var V = ee.responseJSON && ee.responseJSON.msg
                      , ue = w;
                    typeof V == "string" && V.indexOf("InvalidFileTypeError") === 0 ? ue = _ : typeof V == "string" && V.indexOf("MaxFileSizeError") === 0 && (ue = c),
                    U.text(ue),
                    d.removeAttr("data-value"),
                    d.val(""),
                    oe.toggle(!1),
    ...
    var Gv = f( (FG, kv) => {
        ...
        vt.define("navbar", kv.exports = function(e, t) {
            var n = {}, r = e.tram, i = e(window), o = e(document), s = t.debounce, a, u, l, m, v = vt.env(), p = '<div class="w-nav-overlay" data-wf-ignore />', y = ".w-nav", T = "w--open", I = "w--nav-dropdown-open", S = "w--nav-dropdown-toggle-open", b = "w--nav-dropdown-list-open", R = "w--nav-link-open", O = OF.triggers, L = e();
            ...
            function j(d) {
                return function(F) {
                    ...
                    case Ae.HOME:
                    case Ae.END:
                        return d.open ? (F.keyCode === Ae.END ? d.selectedIdx = d.links.length - 1 : d.selectedIdx = 0,
                        ne(d),
                        F.preventDefault(),
            ...
            function B(d) {
                return function(F) {
                    if (d.open)
                        ...
                        case Ae.HOME:
                        case Ae.END:
                            return F.keyCode === Ae.END ? d.selectedIdx = d.links.length - 1 : d.selectedIdx = 0,
                            ne(d),
                            F.preventDefault(),
                            F.stopPropagation();
                        case Ae.ESCAPE:
            ...
            function E(d) {
                return d.outside && o.off("click" + y, d.outside),
                function(F) {
                    var Y = e(F.target);
            ...
            function se(d) {
                ...
                return F.animOver ? d.menu.height(Y) : d.el.css("position") !== "fixed" && (Y -= d.el.outerHeight(!0)),
            ...
            function K(d, F) {
                ...
                var Y = d.config;
                if ((Y.animation === "none" || !r.support.transform || Y.duration <= 0) && (F = !0),
                O.outro(0, d.el[0]),
    ...
    var Uv = f( (qG, Vv) => {
        ...
        yt.define("slider", Vv.exports = function(e, t) {
            var n = {}, r = e.tram, i = e(document), o, s, a = yt.env(), u = ".w-slider", l = '<div class="w-slider-dot" data-wf-ignore />', m = '<div aria-live="off" aria-atomic="true" class="w-slider-aria-label" data-wf-ignore />', v = "w-slider-force-show", p = xF.triggers, y, T = !1;
            n.ready = function() {
                s = yt.env("design"),
                I()
            }
            ...
            function S() {
                yt.resize.off(R),
                yt.redraw.off(n.redraw)
            }
            function b() {
                yt.resize.on(R),
                yt.redraw.on(n.redraw)
            }
            function R() {
            ...
            function O(E, k) {
                ...
                g.nav.off(u),
                L(g),
                s ? (g.el.on("setting" + u, A(g)),
                q(g),
                g.hasTimer = !1) : (g.el.on("swipe" + u, A(g)),
                ...
                a || g.mask.contents().filter(function() {
            ...
            function C(E, k, h) {
                return function(g) {
                    if (k)
                        E.hasFocus[h] = k;
                    else if (e.contains(E.el.get(0), g.relatedTarget) || (E.hasFocus[h] = k,
                    E.hasFocus.mouse && h === "keyboard" || E.hasFocus.keyboard && h === "mouse"))
                        return;
                    k ? (E.ariaLiveLabel.attr("aria-live", "polite"),
                    E.hasTimer && q(E)) : (E.ariaLiveLabel.attr("aria-live", "off"),
                    E.hasTimer && te(E))
                }
            }
            function W(E, k) {
            ...
            function te(E) {
                ...
                var k = E.config
                  , h = k.timerMax;
                h && E.timerCount++ > h || (E.timerId = window.setTimeout(function() {
                    E.timerId == null || s || (z(E)(),
                    te(E))
                }, k.delay))
            }
            function q(E) {
            ...
            function A(E) {
                return function(k, h) {
                    ...
                    if (k.type === "swipe")
                        return g.disableSwipe || yt.env("editor") ? void 0 : h.direction === "left" ? z(E)() : h.direction === "right" ? H(E)() : void 0;
            ...
            function j(E, k) {
                ...
                var X = k.index
                  , G = {};
                X < 0 ? (X = g.length - 1,
                h.infinite && (G.x = -E.endX,
                G.from = 0,
                G.to = g[0].width)) : X >= g.length && (X = 0,
                h.infinite && (G.x = g[g.length - 1].width,
                G.from = -g[g.length - 1].x,
                G.to = G.from - G.x)),
                E.index = X;
                var Z = E.nav.children().eq(X).addClass("w-active").attr("aria-pressed", "true").attr("tabindex", "0");
                E.nav.children().not(Z).removeClass("w-active").attr("aria-pressed", "false").attr("tabindex", "-1"),
                h.hideArrows && (E.index === g.length - 1 ? E.right.hide() : E.right.show(),
                ...
                if (d.find(Xv).removeAttr("tabindex"),
                ...
                if (E.index === E.previous)
                    return;
                if (s || E.ariaLiveLabel.text(`Slide ${X + 1} of ${g.length}.`),
                U === "cross") {
                ...
                h.infinite && G.x ? (r(E.slides.not(F)).set({
                    visibility: "",
                    x: G.x
                }).add(_).start({
                    x: se
                ...
                E.shifted = F) : (h.infinite && E.shifted && (r(E.shifted).set({
                    visibility: "",
                    x: oe
                }),
                E.shifted = null),
            ...
            function ne(E) {
                ...
                E.slides.each(function(se, K) {
                    ...
                    e(K).attr("aria-label", d),
                    e(K).attr("role", "group")
                }),
                E.endX = g,
                s && (E.pages = null),
                E.nav.length && E.pages !== k && (E.pages = k,
                re(E));
                var oe = E.index;
                oe >= k && (oe = k - 1),
                j(E, {
            ...
            function re(E) {
                var k = [], h, g = E.el.attr("data-nav-spacing");
                g && (g = parseFloat(g) + "px");
                for (var X = 0, G = E.pages; X < G; X++)
                    h = e(l),
                    h.attr("aria-label", "Show slide " + (X + 1) + " of " + G).attr("aria-pressed", "false").attr("role", "button").attr("tabindex", "-1"),
            ...
            function le(E) {
                var k = E.mask.width();
                return E.maskWidth !== k ? (E.maskWidth = k,
                !0) : !1
            }
            function Ie(E) {
                var k = 0;
                return E.slides.each(function(h, g) {
                    k += e(g).outerWidth(!0)
                }),
                E.slidesWidth !== k ? (E.slidesWidth = k,
                !0) : !1
            }
            return n
        }
    ...
    "events": {
        ...
        "e-68": {
            ...
            "target": {
                ...
                "originalId": "6705807fd8f75b7e3a2d3bdc|06c99d02-5b1b-ab82-23bb-aa92962fad52",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".exp-slider_arrow",
        ...
        "e-112": {
            ...
            "target": {
                ...
                "originalId": "670ad54b73f57e3c96b7a675|a24b44d3-91b8-6a6c-aaf2-27ae9adc25c4",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".footer_social-link",
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "target": {
                                ...
                                "selectorGuids": ["eb70c2a8-3bcd-dded-675b-cf9805985161", "80c8c62a-60e0-7ba3-d041-13625a5d51b3"]
                            },
                            "yValue": 5,
                            "xUnit": "PX",
                            "yUnit": "rem",
                        ...
                        "config": {
                            ...
                            "target": {
                                ...
                                "selectorGuids": ["eb70c2a8-3bcd-dded-675b-cf9805985161", "ce1c6c2c-2ef1-a485-02a8-a32b10364e7c"]
                            },
                            "yValue": 7,
                            "xUnit": "PX",
                            "yUnit": "rem",
                        ...
                        "config": {
                            ...
                            "target": {
                                ...
                                "selectorGuids": ["eb70c2a8-3bcd-dded-675b-cf9805985161", "557edea9-8d53-fb47-483c-cfdeced4177d"]
                            },
                            "yValue": 12,
                            "xUnit": "PX",
                            "yUnit": "rem",
                        ...
                        "config": {
                            ...
                            "target": {
                                ...
                                "selectorGuids": ["eb70c2a8-3bcd-dded-675b-cf9805985161", "b4de19f3-f263-7496-d564-44abd2f8f3d1"]
                            },
                            "yValue": 12,
                            "xUnit": "PX",
                            "yUnit": "rem",
                        ...
                        "config": {
                            ...
                            "target": {
                                ...
                                "selectorGuids": ["eb70c2a8-3bcd-dded-675b-cf9805985161", "b677b4d2-4c0c-54b8-131b-8b89ab717d99"]
                            },
                            "yValue": 10,
                            "xUnit": "PX",
                            "yUnit": "rem",
...
let currentSlide = 0;
        ...
        setInterval(showNextSlide, 2000); // Show each slide one by one every 2 seconds
...
window.addEventListener('scroll', function () {
    ...
    if (window.scrollY > 1500) {  // you can change 100 to any value
